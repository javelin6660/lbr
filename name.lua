...
do 
    local dropdownOption = {} do 
        ...
        dropdownOption.select = function(self) 
            self.selected = true
            self.dropdown:setValue(self.value)
            self.dropdown:close()
            return self
        end
        ...
        dropdownOption.new = function(self) 
            ...
            instances.label = instances.optionButton['#label']
...
do 
    local dropdown = {} do 
            ...
            local instances = {} do 
                ...
                local clickSensor = Instance.new('TextButton') do 
                    ...
                    local nameLabel = Instance.new('TextLabel') do 
                        ...
                        nameLabel.Text = 'dropdown'
                        nameLabel.TextColor3 = theme.TextPrimary
                        nameLabel.TextSize = 14
                        nameLabel.TextStrokeColor3 = theme.TextStroke
                        nameLabel.TextStrokeTransparency = 0.8
                        nameLabel.TextTransparency = 0
                        nameLabel.TextWrapped = false
                        nameLabel.TextXAlignment = 'Left'
                        nameLabel.TextYAlignment = 'Center'
                        nameLabel.Visible = true
                        nameLabel.ZIndex = 35
                        nameLabel.Parent = clickSensor
        ...
        dropdown.open = function(self) 
            if (self.openState) then return self end
            self.openState = true 
            self:fireEvent('onOpen')
            ...
            menu.Visible = true
            local menuHeight = math.min(#self.options * 20 + 8, 100)
            ...
            tween(self.instances.controlFrame, {
                Size = UDim2.new(1, 0, 0, 20 + menuHeight)
            }, 0.2, 1)
        ...
        dropdown.close = function(self) 
            if (not self.openState) then return self end
            self.openState = false
            self:fireEvent('onClose')
            ...
            tween(self.instances.controlFrame, {
                Size = UDim2.new(1, 0, 0, 20)
            }, 0.2, 1):GetPropertyChangedSignal('PlaybackState'):Connect(function()
        ...
        dropdown.setValue = function(self, value) 
            ...
            for _, opt in ipairs(self.options) do
                if (opt.value == value) then
                    opt.selected = true
                    opt.instances.optionButton.BackgroundColor3 = theme.Button3
                else
                    opt.selected = false
                    opt.instances.optionButton.BackgroundColor3 = theme.Button1
                end
            end
        ...
        dropdown.addOption = function(self, value) 
            local option = elemClasses.dropdownOption:new()
            option.value = value
            option.dropdown = self
            option.instances.label.Text = tostring(value)
            option.instances.optionButton.Parent = self.instances.menu
            
            table.insert(self.options, option)
            
            self.instances.menu.CanvasSize = UDim2.fromOffset(0, #self.options * 20 + 8)
        ...
        dropdown.new = function(self) 
            ...
            instances.label = instances.button['#label']
            instances.icon = instances.button['#icon']
            instances.nameLabel = instances.clickSensor['#name']
            instances.menu = instances.controlFrame['#menu']
    ...
    elemClasses.section.addDropdown = function(self, settings, callback) 
        ...
        local s_options = settings.options or {}
        local s_default = settings.default or (s_options[1] or nil)
        ...
        new.instances.nameLabel.Text = s_title
        new.instances.controlFrame.Parent = self.instances.controlMenu
        ...
        if (s_default) then
            new:setValue(s_default)
        end
        
        if (typeof(callback) == 'function') then
            new:bindToEvent('onChange', callback) 
        end
